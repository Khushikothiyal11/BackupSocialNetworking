...
router.get("/galleries", getPhotoGallries); // http://localhost:5000/api//users/login
router.get("/users/:id", authMiddleware, getUser);
router.get("/users", authMiddleware, getUsers);
router.get("/getallusers/:id", authMiddleware, getAllUsersById); // Get all users except the logged-in user
